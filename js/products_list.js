...
const renderProducts = (data) => {
  ...
  for (let product of data) {
    productDiv.innerHTML += `
    <div class="col">
              <div class="card" id=${product.id} onclick="redirectDetail(this.id)">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><strong>${product.prices["price"]}</strong></p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">Product Details</button>
                    </div>
                  </div>
                </div>
              </div>
...
function redirectDetail(id) {
  window.location = "../html/product_detail.html?id=" + id;
}
function redirectBasket(id) {
  addProduct();
  window.location = "../html/cart_basket.html?id=" + id;
}
